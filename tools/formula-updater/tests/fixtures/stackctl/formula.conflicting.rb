...
class Stackctl < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/AniTrend/stackctl/releases/download/v0.0.1/stackctl-v0.0.1-aarch64-apple-darwin.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/AniTrend/stackctl/releases/download/v0.0.1/stackctl-v0.0.1-aarch64-unknown-linux-gnu.tar.gz"
